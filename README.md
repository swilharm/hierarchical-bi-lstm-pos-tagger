...
```
cd existing_repo
git remote add origin https://gitup.uni-potsdam.de/swilharm/hierarchical-bi-lstm-pos-tagger.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitup.uni-potsdam.de/swilharm/hierarchical-bi-lstm-pos-tagger/-/settings/integrations)
